      ...
      <section className="hero" id="home">
        <div className="container f_flex top">
          <div className="left top">
            ...
            <p>
              I am a newly graduated programmer, I have a good experience in
              programming. During my time as a student, I developed projects
              related to software development. I've always been the type of
              person to take your downsides and turn them into upsides, so I'm a
              firm believer that there's always a way to overcome every
              obstacle.
            </p>{" "}
